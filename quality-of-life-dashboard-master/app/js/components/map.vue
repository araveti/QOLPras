            ...
            if (!iOS) {
                ...
                map.on('mousemove', function (e) {
                    ...
                    popup.setLngLat(map.unproject(e.point))
                        .setHTML(`<div style="text-align: center; margin: 0; padding: 0;"><h3 style="font-size: 1.2em; margin: 0; padding: 0; line-height: 1em; font-weight: bold;">BlockID ${feature.properties.id}</h1>${val}</div>`)
                        .addTo(map);
