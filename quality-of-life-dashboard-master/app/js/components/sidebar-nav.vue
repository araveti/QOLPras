<template lang="html">
    <nav class="demo-navigation mdl-navigation">
        ...
        <template v-if="privateState.filterVal">
            <a class="mdl-navigation__link" v-on:click="changeFilter(null)" href="javascript:void(0)"><i class="material-icons navleft" role="presentation">chevron_left</i>Back</a>
        ...
        <template v-else >
            ...
            <a v-for="category in filterCategories(privateState.data)" class="mdl-navigation__link" v-on:click="changeFilter(category)" href="javascript:void(0)">{{category}}<i class="material-icons navright" role="presentation">chevron_right</i></a>
